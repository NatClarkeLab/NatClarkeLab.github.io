...
<div class="container-xxl py-4">
  <header class="mb-4">
    <h1 class="mb-2">Join the Clarke Lab</h1>
    <p class="lead text-muted mb-0">We’re building a collaborative multi-disciplinary team to study how cells evolved to stick together — across systems and scales.</p>
  </header>
  ...
  <!-- Optional quick bullets (delete if you don’t want them) -->
  <section class="mt-4">
    <h2 class="h5 mb-2">What we value</h2>
    <ul class="mb-0">
      <li>Curiosity, creativity, and kindness</li>
      <li>Clear communication and teamwork</li>
      <li>Careful, reproducible work</li>
      <li>Openness to learning new approaches (wet lab ↔ computational)</li>
    </ul>
  </section>
  ...
  <div class="mt-4 d-flex flex-wrap gap-2">
    <a class="btn btn-primary" href="mailto:natclarke@miami.edu">Email Nat</a>
    <a class="btn btn-outline-secondary" href="{{ '/research/' | relative_url }}">Explore our research</a>
    <a class="btn btn-outline-secondary" href="{{ '/team/' | relative_url }}">Meet the team</a>
  </div>

  <!-- (Optional) light-divider to close the page -->
  <hr class="my-5">
  <p class="text-muted small mb-0">Our lab welcomes applicants from any race, ethnicity, religion, national origin, gender identity, gender expression, caregiver or family commitment, political affiliation, sexual orientation, and eligible age or disability status. We are committed to fostering a supportive and collaborative lab environment.</p>
</div>
